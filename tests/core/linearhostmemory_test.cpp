...
int main(int /*argc*/, char** /*argv*/)
{
  try
  {
    ...
    *h_32f_C1 = val_32f;
    ...
    // COPY CHECK
    {
      imp::LinearMemory8uC1 check_8u_C1(h_8u_C1->length());
      imp::LinearMemory32fC1 check_32f_C1(h_32f_C1->length());
    ...
    {
      imp::LinearMemory8uC1 check_8u_C1(*h_8u_C1);
      imp::LinearMemory32fC1 check_32f_C1(*h_32f_C1);
