...
struct Texture2D : Texture
{
  ...
  __host__ explicit Texture2D(/*pixel_container_t data, size_type pitch,*/
                              imp::Size2u size,
...
//    tex_res.res.pitch2D.pitchInBytes = pitch;
    tex_res.res.pitch2D.desc = cudaCreateChannelDesc<pixel_t>();
    ...
    cudaCreateTextureObject(&tex, &tex_res, &tex_desc, 0);
